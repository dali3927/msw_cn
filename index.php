<?php get_header(); ?>
		...
		<div class="col1">
			...
			<?php if (get_option('woo_exclude')) update_option("woo_exclude", ""); // reset featured posts exclude ?>
			<?php if (get_option('woo_show_carousel') == 'true') { include (TEMPLATEPATH . "/includes/featured.php");} ?>
